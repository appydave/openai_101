OpenAI::Files.new(client: self).upload(file: "path/to/file.jsonl", purpose: "fine-tune")
OpenAI::Files.new(client: self).upload(file: "path/to/file.jsonl", purpose: "assistants")
